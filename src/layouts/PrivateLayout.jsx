...
function LayoutContent() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <aside
        className={cn(
          "bg-sidebar text-sidebar-foreground border-sidebar-border border-r transition-all duration-200",
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <AppHeader />
        <main className="min-h-[calc(100vh-3.5rem)] flex-1 p-3 pb-20 sm:p-4 lg:p-6 lg:pb-25">
          <Outlet />
        </main>
        <AppFooter />
      </div>
